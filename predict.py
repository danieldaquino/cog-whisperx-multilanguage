...
class Predictor(BasePredictor):
    def setup(self):
        ...
        for language_code in self.languages:
            ...
            self.alignment_models[language_code] = {"model": alignment_model, "metadata": metadata}
        ...
        with torch.inference_mode():
            ...
            if align_output:
                ...
                result = whisperx.align(
                    result['segments'],
                    self.alignment_models[result['language']]['model'],
                    self.alignment_models[result['language']]['metadata'],
                    str(audio),
                    self.device,
